...
9. Save artifacts under the canonical output folder `storywright/YYYY-MM-DD-HHmm-epic-<slug>/` (project root) (`<slug>` = the epic title per Rule I, after stripping a leading `Epic —`/`Epic:`/`Epic ` prefix, case-insensitive).

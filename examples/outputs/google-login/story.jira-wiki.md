...
h3. Business Rules
# Solo cuentas de Google con email verificado pueden usar el login social.
# Si la cuenta es de Workspace, el dominio debe estar en la lista de dominios permitidos.
# La sesión expira tras 30 días de inactividad.

{panel:title=⚠️ Assumed}
persona = visitante nuevo sin cuenta previa (auto-inferido del prompt "Permitir login con Google"; confirmar si aplica también a usuarios existentes con password).
{panel}
